...
public class CommonDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public CommonDialog.Builder setView(int layoutResId, CommonDialogFragment.OnHandleViewCallBack callBack) {
         ...
         * @return
         */
        public CommonDialog.Builder setView(View view,CommonDialogFragment.OnHandleViewCallBack callBack) {
         ...
         * @param height 高
         */
        public CommonDialog.Builder setWidthAndHeight(int width, int height) {
         ...
         * @param y Y轴
         */
        public CommonDialog.Builder setXAndY(int x, int y) {
         ...
         */
        public CommonDialog.Builder setBackGroundLevel(float level) {
         ...
         */
        public CommonDialog.Builder setOutsideTouchable(boolean touchable) {
         ...
         * @return Builder
         */
        public CommonDialog.Builder setAnimationStyle(int animationStyle) {
